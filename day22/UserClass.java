...
public class UserClass {
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			System.out.println("8. Add incentives for sales-employee.");
	...
	public void salesIncentive()
	{
		System.out.println("Enter intencive amt ");
		int incentive= new Scanner(System.in).nextInt();
		boolean value = empOperations.addIncetive(incentive);
		
		if (value){
			System.out.println("intencive amt added");
			
		}
		else{
			System.out.println("Eroor while adding incentives");
		}
	...
	public void displayEmployeeDetails(Employee e)
	{
		...
		if(e instanceof SalesEmployee)
		{
			...
			System.out.println("Basic Salary "+sales.getEmployeeSalary());
			System.out.println("Incentives "+sales.getIncentives());
			System.out.println("Employee Salary "+sales.finalSalary());
			//sales.get
		}
